...
v_x = odom.linear_velocity_x.to_numpy()
v_y = odom.linear_velocity_y.to_numpy()
t = odom.time.to_numpy()

plt.plot(t, v_x, label='Theta')
plt.xlabel('Time [sec]')
plt.ylabel('v_x [m/s]')
plt.grid(True)
plt.legend()
